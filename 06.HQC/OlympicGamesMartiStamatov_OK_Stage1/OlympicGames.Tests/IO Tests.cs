...
//            var parser = typeof(CommandParser).GetField("instance", BindingFlags.Static | BindingFlags.NonPublic);
//            var commandProcessor = typeof(CommandProcessor).GetField("instance", BindingFlags.Static | BindingFlags.NonPublic);
//            var factory = typeof(Engine).GetField("instance", BindingFlags.Static | BindingFlags.NonPublic);
//            var comitee = typeof(OlympicCommittee).GetField("instance", BindingFlags.Static | BindingFlags.NonPublic);

//            instance.SetValue(null, null);
//            parser.SetValue(null, null);
//            commandProcessor.SetValue(null, null);
//            factory.SetValue(null, null);
//            comitee.SetValue(null, null);
