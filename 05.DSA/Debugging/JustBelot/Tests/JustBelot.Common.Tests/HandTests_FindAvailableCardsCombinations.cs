namespace JustBelot.Common.Tests
{
    ...
    public class HandTests_FindAvailableCardsCombinations
    {
        ...
        public void FourOfAKingAces()
        {
            ...
            Assert.IsTrue(combinations.Contains(new CardsCombination(CardsCombinationType.FourOfNines, CardType.Ace)));
        }
        ...
        public void NoFourOfAKingSevens()
        {
            ...
            Assert.IsTrue(combinations.Contains(new CardsCombination(CardsCombinationType.FourOfAKind, CardType.Seven)));
        }
        ...
        public void QuartFromJackToAce()
        {
            ...
            Assert.AreEqual(1, combinations.Count);
            Assert.IsTrue(combinations.Contains(new CardsCombination(CardsCombinationType.Quart, CardType.Eight, CardSuit.Diamonds)));
        }
        ...
        public void FourOfAKindAndQuart()
        {
            ...
            Assert.AreEqual(2, combinations.Count);
            Assert.IsTrue(combinations.Contains(new CardsCombination(CardsCombinationType.FourOfJacks, CardType.King)));
