        ...
        private string CreateChair(string model, string material, decimal price, decimal height, int legs, string type)
        {
            ...
            switch (type)
            {
                case EngineConstants.NormalChairType:
                    chair = (IFurniture)this.furnitureFactory.CreateChair(model, material, price, height, legs);
                    break;
                case EngineConstants.AdjustableChairType:
                    chair = (IFurniture)this.furnitureFactory.CreateAdjustableChair(model, material, price, height, legs);
                    break;
                case EngineConstants.ConvertibleChairType:
                    chair = (IFurniture)this.furnitureFactory.CreateConvertibleChair(model, material, price, height, legs);
                    break;
                default:
