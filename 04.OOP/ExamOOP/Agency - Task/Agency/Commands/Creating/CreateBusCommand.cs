...
namespace Agency.Commands.Creating
{
    public class CreateBusCommand : ICommand
    {
        ...
        public string Execute(IList<string> parameters)
        {
            ...
            IBus bus = this.factory.CreateBus(passengerCapacity, pricePerKilometer);
                //CreateBus(int passengerCapacity, decimal pricePerKilometer)
            this.engine.Vehicles.Add((IVehicle)bus);
