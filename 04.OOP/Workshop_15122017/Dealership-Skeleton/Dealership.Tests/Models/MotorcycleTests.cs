...
namespace Dealership.Tests.Models
{
    ...
    public class MotorcycleTests
    {
        ...
        {
            Assert.ThrowsException<NullReferenceException>(() => new Motorcycle("make", null, 10, "category"));
        }
        ...
        {
            Assert.ThrowsException<NullReferenceException>(() => new Motorcycle("make", "model", 10, null));
        }
